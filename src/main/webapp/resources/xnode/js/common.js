/*
 * Copyright 2015-2016 xuce. All rights reserved.
 * 
 * JavaScript - Common
 * Version 1.0_beta
 */
	...
	$.fn.extend({
		browser: function(options) {
			var settings = {
				...
				isUpload: true,
				browserUrl: xc.base + "/file/browser.jhtml",
				uploadUrl: xc.base + "/file/upload.jhtml",
				callback: null
			};
			$.extend(settings, options);
					...
					function createBrowserList(path, data) {
						...
						$.each(data, function(i, fileInfo) {
							...
							if (fileInfo.isDirectory) {
								iconUrl = xc.base + "/resources/images/folder_icon.gif";
								title = fileInfo.name;
								...
								iconUrl = xc.base + "/resources/images/file_icon.gif";
								title = fileInfo.name + " (" + Math.ceil(fileInfo.size / 1024) + "KB, " + new Date(fileInfo.lastModified).toLocaleString() + ")";
							}
